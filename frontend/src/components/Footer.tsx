    ...
    <footer className="bg-white border-t border-gray-200 mt-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              Comprehensive reef aquarium management system
            </p>
            <p className="text-xs text-gray-500 mt-2">
              Created by <span className="font-medium text-ocean-600">Edi Prifti</span>
            </p>
            <p className="text-xs text-gray-500">
              with <span className="text-red-500">❤️</span> and Claude Sonnet 4.5
            </p>
          </div>
          ...
          {/* Support */}
          <div>
            <h3 className="text-sm font-semibold text-gray-900 mb-2">Support the Project</h3>
            <p className="text-xs text-gray-600 mb-3">
              Help keep ReefLab development going
            </p>
        ...
        <div className="mt-6 pt-6 border-t border-gray-200 flex items-center justify-between text-xs text-gray-500">
          <p>
            © {new Date().getFullYear()} Edi Prifti. Open source under MIT License.
          </p>
