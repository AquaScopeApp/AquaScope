  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">{t('myTanks')}</h1>
      ...
      <label className="inline-flex items-center cursor-pointer text-sm text-gray-600 dark:text-gray-400">
        <input
          ...
          className="mr-2 rounded border-gray-300 dark:border-gray-600 text-ocean-600 focus:ring-ocean-500 dark:bg-gray-700"
        />
      ...
      {tanks.length === 0 ? (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-12 text-center">
          ...
          <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">{t('noTanksYet')}</h3>
