...
# API routes
from app.api.v1 import auth, tanks, parameters, notes, photos, maintenance, livestock, equipment, icp_tests, admin, parameter_ranges, consumables, finances, dashboard, export, share, species_traits, feeding, diseases
